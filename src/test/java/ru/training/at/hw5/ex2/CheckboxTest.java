...
import ru.training.at.hw5.DataProviders;
import ru.training.at.hw5.JdiPageTest;
import ru.training.at.hw5.utils.ScreenshotListener;
...
public class CheckboxTest extends JdiPageTest {
    ...
    public void checkboxTest(int checkBoxIndex1,
                             int checkBoxIndex2,
        ...
        assertLogs(WATER_CHANGED_TO_TRUE_ENTRY,
                WIND_CHANGED_TO_TRUE_ENTRY,
                METAL_CHANGED_TO_SELEN_ENTRY,
                COLOR_CHANGED_TO_YELLOW_ENTRY);
    }

    @Step("Select elements on Different element page")
    private void selectElements(int checkBoxIndex1,
                                int checkBoxIndex2,
                                int radioButtonIndex,
                                int colorIndex) {
    ...
    private void assertLogs(String expectedWaterLog,
                            String expectedWindLog,
                            String expectedMetalLog,
                            String expectedColorLog) {
